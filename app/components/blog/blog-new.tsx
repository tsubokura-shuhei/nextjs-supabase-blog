...
const BlogNew = () => {
  ...
  return (
    <div className="max-w-screen-mb mx-auto">
      <form onSubmit={onSubmit}>
        <div className="mb-5">
          <div className="text-sm mb-1">タイトル</div>
          <input
            className="w-full bg-gray-100 rounded py-1 px-3 outline-none focus:bg-transparent focus:right-2 focus:ring-yellow-500"
            ref={titleRef}
            type="text"
            id="title"
            placeholder="Title"
        ...
        <div className="text-center mb-5">
          {loading ? (
            ...
            <button
              type="submit"
              className="w-full text-white bg-slate-500 hover:brightness-110 rounded py-1 px-8"
            >
              作成
            </button>
          )}
